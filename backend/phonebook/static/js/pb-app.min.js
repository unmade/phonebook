...
!function(){"use strict";function e(e,n,l,s,t,i,o){function c(e){e&&(C.employee=e,n("employee-detail-right").toggle())}function r(){C.selectedCenter=null,C.selectedDivision=null,C.employees=new s({company:C.selectedCompany,search:C.searchText||null}),C.employees.nextPage()}function u(){C.selectedDivision=null,C.employees=new s({company:C.selectedCompany,center:C.selectedCenter,search:C.searchText||null}),C.employees.nextPage()}function a(){C.employees=new s({company:C.selectedCompany,center:C.selectedCenter,division:C.selectedDivision,search:C.searchText||null}),C.employees.nextPage()}function m(n){var s=4;if(!n)return C.employees.results.slice(0,s);var t=e.defer();return l.query({search:n,limit:s,offset:0},function(e,n){t.resolve(e.results)}),t.promise}function p(e){return e.surname+" "+e.firstname+" "+e.patronymic}function d(){return C.companies||t.query(function(e){C.companies=e})}function y(){return C.centers&&C.centers.results.length&&C.centers.results[0].company==C.selectedCompany?void 0:i.query({company:C.selectedCompany},function(e){C.centers=e})}function v(){return C.divisions&&C.divisions.results.length&&C.divisions.results[0].center==C.selectedCenter?void 0:o.query({center:C.selectedCenter},function(e){C.divisions=e})}function f(e){C.selectedCompany=null,C.selectedCenter=null,C.selectedDivision=null,C.employees=new s({search:e}),C.employees.nextPage()}var C=this;C.employees=new s,C.companies=null,C.centers=null,C.divisions=null,C.selectedCompany=null,C.selectedCenter=null,C.selectedDivision=null,C.companyChanged=r,C.centerChanged=u,C.divisionChanged=a,C.employeeSearch=m,C.getEmployeeName=p,C.loadCompanies=d,C.loadCenters=y,C.loadDivisions=v,C.search=f,C.showEmployeeDetail=c}angular.module("pbApp.employees").controller("EmployeeListCtrl",e),e.$inject=["$q","$mdSidenav","employeeService","EmployeeScroll","companyService","centerService","divisionService"]}();
