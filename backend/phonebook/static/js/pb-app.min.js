!function(){"use strict";angular.module("pbApp",["ngRoute","ngResource","ngMaterial","infinite-scroll","pbApp.routes","pbApp.layout","pbApp.employees","pbApp.companies","pbApp.feedback"]),angular.module("pbApp.routes",[])}();
...
!function(){"use strict";function e(e,n,l,t,s,i,o){function c(e){e&&(C.employee=e,n("employee-detail-right").toggle())}function r(){C.selectedCenter=null,C.selectedDivision=null,C.employees=new t({company:C.selectedCompany,search:C.searchText||null}),C.employees.nextPage()}function u(){C.selectedDivision=null,C.employees=new t({company:C.selectedCompany,center:C.selectedCenter,search:C.searchText||null}),C.employees.nextPage()}function a(){C.employees=new t({company:C.selectedCompany,center:C.selectedCenter,division:C.selectedDivision,search:C.searchText||null}),C.employees.nextPage()}function m(n){var t=8;if(!n)return C.employees.results.slice(0,t);var s=e.defer();return l.query({search:n,limit:t,offset:0},function(e,n){s.resolve(e.results)}),s.promise}function p(e){return e.surname+" "+e.firstname+" "+e.patronymic}function d(){return C.companies||s.query(function(e){C.companies=e})}function y(){return C.centers&&C.centers.results.length&&C.centers.results[0].company==C.selectedCompany?void 0:i.query({company:C.selectedCompany},function(e){C.centers=e})}function v(){return C.divisions&&C.divisions.results.length&&C.divisions.results[0].center==C.selectedCenter?void 0:o.query({center:C.selectedCenter},function(e){C.divisions=e})}function f(e){C.selectedCompany=null,C.selectedCenter=null,C.selectedDivision=null,C.employees=new t({search:e}),C.employees.nextPage()}var C=this;C.employees=new t,C.companies=null,C.centers=null,C.divisions=null,C.selectedCompany=null,C.selectedCenter=null,C.selectedDivision=null,C.companyChanged=r,C.centerChanged=u,C.divisionChanged=a,C.employeeSearch=m,C.getEmployeeName=p,C.loadCompanies=d,C.loadCenters=y,C.loadDivisions=v,C.search=f,C.openSidenav=function(){n("left").toggle()},C.showEmployeeDetail=c}angular.module("pbApp.employees").controller("EmployeeListCtrl",e),e.$inject=["$q","$mdSidenav","employeeService","EmployeeScroll","companyService","centerService","divisionService"]}();
