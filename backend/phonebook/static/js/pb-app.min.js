...
!function(){"use strict";function e(e,n,i,o,r){function t(e){e&&(s.company=e,i("company-detail-right").toggle())}function a(i){var r=4;if(!i)return s.companies.results.slice(0,r);var t=e.defer(),a=n("englishCharsToRussian")(i);return o.query({search:a,limit:r,offset:0},function(e,n){t.resolve(e.results)}),t.promise}var s=this;s.companies=new r({limit:40,offset:0}),s.showCompanyDetail=t,s.companySearch=a}angular.module("pbApp.companies").controller("CompanyListCtrl",e),e.$inject=["$q","$filter","$mdSidenav","companyService","companyScroll"]}();
...
!function(){"use strict";function e(e,n,l,s,t,i,o,c){function r(e){e&&(h.employee=e,l("employee-detail-right").toggle())}function u(){h.selectedCenter=null,h.selectedDivision=null,h.employees=new t({company:h.selectedCompany,search:h.searchText||null}),h.employees.nextPage()}function a(){h.selectedDivision=null,h.employees=new t({company:h.selectedCompany,center:h.selectedCenter,search:h.searchText||null}),h.employees.nextPage()}function d(){h.employees=new t({company:h.selectedCompany,center:h.selectedCenter,division:h.selectedDivision,search:h.searchText||null}),h.employees.nextPage()}function p(l){var t=8;if(!l)return h.employees.results.slice(0,t);var i=e.defer(),o=n("englishCharsToRussian")(l);return s.query({search:o,limit:t,offset:0},function(e,n){i.resolve(e.results)}),i.promise}function m(){return h.companies||i.query(function(e){h.companies=e})}function y(){return h.centers&&h.centers.results.length&&h.centers.results[0].company==h.selectedCompany?void 0:o.query({company:h.selectedCompany},function(e){h.centers=e})}function v(){return h.divisions&&h.divisions.results.length&&h.divisions.results[0].center==h.selectedCenter?void 0:c.query({center:h.selectedCenter},function(e){h.divisions=e})}function f(){l("left").toggle()}function C(e){h.selectedCompany=null,h.selectedCenter=null,h.selectedDivision=null,h.employees=new t({search:e}),h.employees.nextPage()}var h=this;h.employees=new t,h.companies=null,h.centers=null,h.divisions=null,h.selectedCompany=null,h.selectedCenter=null,h.selectedDivision=null,h.companyChanged=u,h.centerChanged=a,h.divisionChanged=d,h.employeeSearch=p,h.loadCompanies=m,h.loadCenters=y,h.loadDivisions=v,h.openSidenav=f,h.search=C,h.showEmployeeDetail=r}angular.module("pbApp.employees").controller("EmployeeListCtrl",e),e.$inject=["$q","$filter","$mdSidenav","employeeService","EmployeeScroll","companyService","centerService","divisionService"]}();
