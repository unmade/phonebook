...
!function(){"use strict";function e(e,n,i,o,t){function a(i){var t=4;if(!i)return s.companies.results.slice(0,t);var a=e.defer(),r=n("englishCharsToRussian")(i);return o.query({search:r,limit:t,offset:0},function(e,n){a.resolve(e.results)}),a.promise}function r(){i("company-detail-right").close()}function c(e){e&&(s.company=e,i("company-detail-right").toggle())}var s=this;s.companies=new t({limit:100,offset:0}),s.companySearch=a,s.closeCompanyDetail=r,s.openCompanyDetail=c}angular.module("pbApp.companies").controller("CompanyListCtrl",e),e.$inject=["$q","$filter","$mdSidenav","companyService","companyScroll"]}();
...
!function(){"use strict";function e(e,t,c){var i=this;i.feedbacks=c.query({limit:50,offset:0})}angular.module("pbApp.feedback").controller("FeedbackListCtrl",e),e.$inject=["$mdDialog","$mdToast","feedbackService"]}();
!function(){"use strict";function e(){return{bindToController:!0,controller:t,controllerAs:"newFeedback",replace:!0,restrict:"AE",scope:{buttonClass:"@buttonClass"},templateUrl:"new-feedback.directive.html"}}function t(e,t,o,c){function i(e){e.sender&&e.text&&c.save({sender:e.sender,text:e.text},function(e){r()},function(e){l()})}function l(){o.show(o.simple().textContent("Отправка не удалась!").position("top right").hideDelay(3e3))}function r(){o.show(o.simple().textContent("Ваше сообщение принято!").position("top right").hideDelay(3e3))}function s(e){t.show({templateUrl:"new-feedback-dialog.tmpl.html",targetEvent:e,clickOutsideToClose:!0,controller:n,controllerAs:"nfdCtrl",fullscreen:!0}).then(function(e){i(e)})}var a=this;a.showNewFeedbackDialog=s}function n(e){function t(){e.cancel()}function n(){e.hide(o.feedback)}var o=this;o.feedback={sender:null,text:null},o.cancel=t,o.send=n}angular.module("pbApp.feedback").directive("newFeedback",e),t.$inject=["$scope","$mdDialog","$mdToast","feedbackService"],n.$inject=["$mdDialog"]}();
!function(){"use strict";function e(e,n,l,s,t,i,o,c){function r(){h.selectedCenter=null,h.selectedDivision=null,h.employees=new t({company:h.selectedCompany,search:h.searchText||null}),h.employees.nextPage()}function a(){h.selectedDivision=null,h.employees=new t({company:h.selectedCompany,center:h.selectedCenter,search:h.searchText||null}),h.employees.nextPage()}function u(){l("employee-detail-right").close()}function p(){h.employees=new t({company:h.selectedCompany,center:h.selectedCenter,division:h.selectedDivision,search:h.searchText||null}),h.employees.nextPage()}function m(l){var t=8;if(!l)return h.employees.results.slice(0,t);var i=e.defer(),o=n("englishCharsToRussian")(l);return s.query({search:o,limit:t,offset:0},function(e,n){i.resolve(e.results)}),i.promise}function d(){return h.companies||i.query(function(e){h.companies=e})}function y(){return h.centers&&h.centers.results.length&&h.centers.results[0].company==h.selectedCompany?void 0:o.query({company:h.selectedCompany},function(e){h.centers=e})}function v(){return h.divisions&&h.divisions.results.length&&h.divisions.results[0].center==h.selectedCenter?void 0:c.query({center:h.selectedCenter},function(e){h.divisions=e})}function f(e){e&&(h.employee=e,l("employee-detail-right").toggle())}function C(e){h.selectedCompany=null,h.selectedCenter=null,h.selectedDivision=null,h.employees=new t({search:e}),h.employees.nextPage()}var h=this;h.employees=new t,h.companies=null,h.centers=null,h.divisions=null,h.selectedCompany=null,h.selectedCenter=null,h.selectedDivision=null,h.companyChanged=r,h.centerChanged=a,h.closeEmployeeDetail=u,h.divisionChanged=p,h.employeeSearch=m,h.loadCompanies=d,h.loadCenters=y,h.loadDivisions=v,h.openEmployeeDetail=f,h.search=C}angular.module("pbApp.employees").controller("EmployeeListCtrl",e),e.$inject=["$q","$filter","$mdSidenav","employeeService","EmployeeScroll","companyService","centerService","divisionService"]}();
...
!function(){"use strict";function e(){return{restrict:"AE",controller:t,controllerAs:"printCtrl",templateUrl:"directives/employee-print.directive.html"}}function t(e){function t(t){e.show({controller:l,controllerAs:"printDialogCtrl",templateUrl:"print-employee-dialog.tmpl.html",parent:angular.element(document.body),targetEvent:t,clickOutsideToClose:!0,fullscreen:!0})}var r=this;r.showPrintDialog=t}function l(e,t,l,r,i,n){function o(l){var r=8;if(!l)return p.employees.results.slice(0,r);var n=e.defer(),o=t("englishCharsToRussian")(l);return i.query({search:o,limit:r,offset:0},function(e,t){n.resolve(e.results)}),n.promise}function s(){l.hide()}function c(){p.busy=!0;var e,t=function(t){e=t.results,n.print("/static/partials/utils/print-template.html",{employees:e}),p.busy=!1};"all"===p.type&&i.query({limit:99999999},t),"by_company"===p.type&&i.query({limit:99999999,company:p.selectedCompany},t),"custom"===p.type&&t({results:p.selectedEmployees})}var p=this;p.busy=!1,p.companies=r.query(),p.type="all",p.selectedEmployees=[],p.selectedCompany=null,p.selectedItem=null,p.searchText=null,p.employeeSearch=o,p.hide=s,p.print=c}angular.module("pbApp.employees").directive("printEmployees",e),t.$inject=["$mdDialog"],l.$inject=["$q","$filter","$mdDialog","companyService","employeeService","printerService"]}();
