...
!function(){"use strict";angular.module("pbApp.employees",["ngResource"])}();
!function(){"use strict";angular.module("pbApp.feedback",["ngResource"])}();
!function(){"use strict";function e(e,r){e.defaults.xsrfCookieName="csrftoken",e.defaults.xsrfHeaderName="X-CSRFToken",r.defaults.stripTrailingSlashes=!1}angular.module("pbApp").config(e),e.$inject=["$httpProvider","$resourceProvider"]}();
...
!function(){"use strict";function e(e){e.when("/employees",{templateUrl:"/static/partials/employees/employees.html",controller:"EmployeeListCtrl",controllerAs:"ctrl"}).when("/feedback",{templateUrl:"/static/partials/feedback/feedbacks.html",controller:"FeedbackListCtrl",controllerAs:"ctrl"}).otherwise({redirectTo:"/employees"})}angular.module("pbApp.routes").config(e),e.$inject=["$routeProvider"]}();
...
!function(){"use strict";function e(e,n,l,t,o,s,i){function c(e,l){l&&n.show({controller:["employee",r],controllerAs:"dialog",templateUrl:"employee-detail.dialog.tmpl.html",parent:angular.element(document.body),locals:{employee:l},targetEvent:e,clickOutsideToClose:!0})}function r(e){function l(){n.hide()}var t=this;t.employee=e,t.hide=l}function a(){C.selectedCenter=null,C.selectedDivision=null,C.employees=new t({company:C.selectedCompany,search:C.searchText||null}),C.employees.nextPage()}function u(){C.selectedDivision=null,C.employees=new t({company:C.selectedCompany,center:C.selectedCenter,search:C.searchText||null}),C.employees.nextPage()}function m(){C.employees=new t({company:C.selectedCompany,center:C.selectedCenter,division:C.selectedDivision,search:C.searchText||null}),C.employees.nextPage()}function p(n){var t=4;if(!n)return C.employees.results.slice(0,t);var o=e.defer();return l.query({search:n,limit:t,offset:0},function(e,n){o.resolve(e.results)}),o.promise}function d(e){return e.surname+" "+e.firstname+" "+e.patronymic}function y(){return C.companies||o.query(function(e){C.companies=e})}function v(){return C.centers&&C.centers.results.length&&C.centers.results[0].company==C.selectedCompany?void 0:s.query({company:C.selectedCompany},function(e){C.centers=e})}function f(){return C.divisions&&C.divisions.results.length&&C.divisions.results[0].center==C.selectedCenter?void 0:i.query({center:C.selectedCenter},function(e){C.divisions=e})}function h(e){C.selectedCompany=null,C.selectedCenter=null,C.selectedDivision=null,C.employees=new t({search:e}),C.employees.nextPage()}var C=this;C.employees=new t,C.companies=null,C.centers=null,C.divisions=null,C.selectedCompany=null,C.selectedCenter=null,C.selectedDivision=null,C.companyChanged=a,C.centerChanged=u,C.divisionChanged=m,C.employeeSearch=p,C.getEmployeeName=d,C.loadCompanies=y,C.loadCenters=v,C.loadDivisions=f,C.search=h,C.showEmployeeDetail=c}angular.module("pbApp.employees").controller("EmployeeListCtrl",e),e.$inject=["$q","$mdDialog","employeeService","EmployeeScroll","companyService","centerService","divisionService"]}();
!function(){"use strict";function t(t){var s=function(t){this.results=[],this.after=void 0,this.params=angular.copy(t)||{},this.params.offset=0,this.params.limit=20,this.busy=!1};return s.prototype.nextPage=function(){this.busy||null!==this.after&&(this.busy=!0,t.query(this.params,function(t){this.results=this.results.concat(t.results),this.params.offset+=this.params.limit,this.after=t.next,this.busy=!1}.bind(this)))},s}angular.module("pbApp.employees").factory("EmployeeScroll",t),t.$inject=["employeeService"]}();
